        ...
        if (message.content === '.phantomhelp') {
            ...
            const helpEmbed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: '🎮 Minigames & Zueira', value: '```\n.phantom 8ball <pergunta> - O bot prevê o futuro\n.phantom coinflip - Joga cara ou coroa\n.phantom roll - Rola um dado (1-6)\n.phantom rps <pedra|papel|tesoura> - Joga Jokenpô\n.phantom meme - Manda um meme BR aleatório\n.phantom joke - Conta uma piada\n.phantom dadjoke - Piada de tiozão\n.phantom fact - Fato aleatório\n.phantom quote - Frase inspiradora\n.phantom insult <@> - Insulta alguém\n.phantom compliment <@> - Elogia alguém\n.phantom rate <@> - Dá nota (0-10) pra pessoa\n.phantom pp <@> - Mede o p*\n.phantom gayrate <@> - % Viadagem\n.phantom simprate <@> - % Gado\n.phantom cornorate <@> - % Corno\n.phantom gadometro <@> - % Gado (Muu!)\n.phantom gostosorate <@> - % Gostosura\n.phantom machorate <@> - % Macho Alfa\n.phantom burrorate <@> - % Burrice\n.phantom feiorate <@> - % Feiura\n.phantom pobrerate <@> - % Pobreza\n.phantom iq <@> - Mede o QI\n.phantom hack <@> - Finge hackear\n.phantom ship <@> - Máquina do amor\n.phantom marry <@> - Pede em casamento (Interativo)\n.phantom divorce <@> - Pede o divórcio\n.phantom reverse <texto> - Inverte o texto\n.phantom mock <texto> - fInGe fAlAr aSsIm\n.phantom uwu <texto> - deixa o textinho fofo uwu\n```', inline: false },
